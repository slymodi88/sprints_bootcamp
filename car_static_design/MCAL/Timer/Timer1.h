...
#define		TIMER_MODE					    0
#define		COUNTER_RISING_EDGE				1
#define		COUNTER_FALLING_EDGE			2
...
#define TIMER_8BITS_OVF (0x00ff)
#define TIMER_16BITS_OVF (0xffff)
...
extern uint8 gau8_TimerInitialized[3];
/************************************************************************/
